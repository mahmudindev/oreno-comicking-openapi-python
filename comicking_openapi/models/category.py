...
class Category(BaseModel):
    ...
    code: StrictStr
    name: StrictStr
    parent_code: Optional[StrictStr] = Field(alias="parentCode")
    child_count: StrictInt = Field(alias="childCount")
    __properties: ClassVar[List[str]] = ["createdAt", "updatedAt", "typeCode", "code", "name", "parentCode", "childCount"]
