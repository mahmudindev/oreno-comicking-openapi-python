...
class Comic(BaseModel):
    ...
    code: StrictStr
    published_from: Optional[datetime] = Field(alias="publishedFrom")
    published_to: Optional[datetime] = Field(alias="publishedTo")
    total_chapter: Optional[StrictInt] = Field(alias="totalChapter")
    total_volume: Optional[StrictInt] = Field(alias="totalVolume")
    nsfw: Optional[StrictInt]
    nsfl: Optional[StrictInt]
