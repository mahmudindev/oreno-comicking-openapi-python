...
class Image(BaseModel):
    ...
    ulid: StrictStr
    alternative_text: Optional[StrictStr] = Field(alias="alternativeText")
    link_website_host: StrictStr = Field(alias="linkWebsiteHost")
    link_relative_reference: Optional[StrictStr] = Field(alias="linkRelativeReference")
    __properties: ClassVar[List[str]] = ["createdAt", "updatedAt", "ulid", "alternativeText", "linkWebsiteHost", "linkRelativeReference"]
