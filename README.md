...
*ComicApi* | [**add_comic_author_position**](docs/ComicApi.md#add_comic_author_position) | **POST** /rest/comic-author-positions | Add comic author position.
...
*ComicApi* | [**delete_comic_author**](docs/ComicApi.md#delete_comic_author) | **DELETE** /rest/comics/{comicCode}/authors/{positionCode}:{personCode} | Delete comic author.
*ComicApi* | [**delete_comic_author_position**](docs/ComicApi.md#delete_comic_author_position) | **DELETE** /rest/comic-author-positions/{code} | Delete comic author position.
...
*ComicApi* | [**delete_comic_cover**](docs/ComicApi.md#delete_comic_cover) | **DELETE** /rest/comics/{comicCode}/covers/{imageULID} | Delete comic cover.
*ComicApi* | [**delete_comic_external**](docs/ComicApi.md#delete_comic_external) | **DELETE** /rest/comics/{comicCode}/externals/{linkHREF} | Delete comic external.
...
*ComicApi* | [**get_comic_author**](docs/ComicApi.md#get_comic_author) | **GET** /rest/comics/{comicCode}/authors/{positionCode}:{personCode} | Get comic author.
*ComicApi* | [**get_comic_author_position**](docs/ComicApi.md#get_comic_author_position) | **GET** /rest/comic-author-positions/{code} | Get comic author position.
...
*ComicApi* | [**get_comic_cover**](docs/ComicApi.md#get_comic_cover) | **GET** /rest/comics/{comicCode}/covers/{imageULID} | Get comic cover.
*ComicApi* | [**get_comic_external**](docs/ComicApi.md#get_comic_external) | **GET** /rest/comics/{comicCode}/externals/{linkHREF} | Get comic external.
...
*ComicApi* | [**list_comic_author_position**](docs/ComicApi.md#list_comic_author_position) | **GET** /rest/comic-author-positions | List comic author position.
...
*ComicApi* | [**update_comic_author**](docs/ComicApi.md#update_comic_author) | **PATCH** /rest/comics/{comicCode}/authors/{positionCode}:{personCode} | Update comic author.
*ComicApi* | [**update_comic_author_position**](docs/ComicApi.md#update_comic_author_position) | **PATCH** /rest/comic-author-positions/{code} | Update comic author position.
...
*ComicApi* | [**update_comic_cover**](docs/ComicApi.md#update_comic_cover) | **PATCH** /rest/comics/{comicCode}/covers/{imageULID} | Update comic cover.
*ComicApi* | [**update_comic_external**](docs/ComicApi.md#update_comic_external) | **PATCH** /rest/comics/{comicCode}/externals/{linkHREF} | Update comic external.
...
*ComicVolumeApi* | [**delete_comic_volume**](docs/ComicVolumeApi.md#delete_comic_volume) | **DELETE** /rest/comics/{comicCode}/volumes/{number} | Delete comic volume.
*ComicVolumeApi* | [**delete_comic_volume_cover**](docs/ComicVolumeApi.md#delete_comic_volume_cover) | **DELETE** /rest/comics/{comicCode}/volumes/{volumeNumber}/covers/{imageULID} | Delete comic volume cover.
...
*ComicVolumeApi* | [**get_comic_volume**](docs/ComicVolumeApi.md#get_comic_volume) | **GET** /rest/comics/{comicCode}/volumes/{number} | Get comic volume.
*ComicVolumeApi* | [**get_comic_volume_cover**](docs/ComicVolumeApi.md#get_comic_volume_cover) | **GET** /rest/comics/{comicCode}/volumes/{volumeNumber}/covers/{imageULID} | Get comic volume cover.
...
*ComicVolumeApi* | [**update_comic_volume**](docs/ComicVolumeApi.md#update_comic_volume) | **PATCH** /rest/comics/{comicCode}/volumes/{number} | Update comic volume.
*ComicVolumeApi* | [**update_comic_volume_cover**](docs/ComicVolumeApi.md#update_comic_volume_cover) | **PATCH** /rest/comics/{comicCode}/volumes/{volumeNumber}/covers/{imageULID} | Update volume comic cover.
...
*ImageApi* | [**add_image**](docs/ImageApi.md#add_image) | **POST** /rest/images | Add image.
*ImageApi* | [**delete_image**](docs/ImageApi.md#delete_image) | **DELETE** /rest/images/{ulid} | Delete image.
*ImageApi* | [**get_image**](docs/ImageApi.md#get_image) | **GET** /rest/images/{ulid} | Get image.
*ImageApi* | [**list_image**](docs/ImageApi.md#list_image) | **GET** /rest/images | List image.
*ImageApi* | [**update_image**](docs/ImageApi.md#update_image) | **PATCH** /rest/images/{ulid} | Update image.
